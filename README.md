# Google Cloud Client Libraries for Swift - BigQuery Data Transfer API
...
Add `swift-google-cloud-bigquery-datatransfer-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-bigquery-datatransfer-v1.git --from 0.1.0-preview
```

Then add `GoogleBigQueryDataTransferV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleBigQueryDataTransferV1 <target-name> --package swift-google-cloud-bigquery-datatransfer-v1
```
